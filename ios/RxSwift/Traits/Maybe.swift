...
public extension PrimitiveSequenceType where TraitType == MaybeTrait {
    typealias MaybeObserver = (MaybeEvent<ElementType>) -> ()
     ...
     */
    func subscribe(_ observer: @escaping (MaybeEvent<ElementType>) -> ()) -> Disposable {
        var stopped = false
...
public extension PrimitiveSequenceType where TraitType == MaybeTrait {
     ...
     */
    func ifEmpty(default: ElementType) -> Single<ElementType> {
     ...
     */
    func ifEmpty(switchTo other: Maybe<ElementType>) -> Maybe<ElementType> {
    ...
    /**
     ...
     - returns: Observable sequence that contains elements from switchTo sequence if source is empty, otherwise returns source sequence elements.
     */
    func ifEmpty(switchTo other: Single<ElementType>) -> Single<ElementType> {
